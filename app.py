...
def base_ydl_opts():
    """Base yt-dlp options — adds cookies if the file exists."""
    opts = {
        "quiet":       True,
        "no_warnings": True,
        "noplaylist":  True,
    ...
    if os.path.exists(COOKIES_FILE):
        ...
        print(f"[KindEyes] Using cookies from {COOKIES_FILE}")
    return opts
...
if __name__ == "__main__":
    ...
    print(f"Cookies file: {'found ✓' if os.path.exists(COOKIES_FILE) else 'not found — YouTube may block downloads'}")
